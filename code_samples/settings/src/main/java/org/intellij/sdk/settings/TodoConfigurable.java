...
import com.intellij.ide.todo.configurable.*;
...
public class TodoConfigurable implements SearchableConfigurable, Configurable.NoScroll {
  ...
  public JComponent createComponent() {
    ...
    nameColumn.setCellRenderer(new org.intellij.sdk.settings.TodoConfigurable.MyFilterNameTableCellRenderer());
  ...
  protected @NotNull TodoPattern [] getTodoPatternsToDisplay(TodoConfiguration todoConfiguration) {
