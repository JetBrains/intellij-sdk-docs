...
| `com.intellij.ide.ui.laf.intellij.MacIntelliJIconCache` class renamed to `com.intellij.ide.ui.laf.IconCache` | Use more generic class name `com.intellij.ide.ui.laf.IconCache` |
...
| `com.jetbrains.php.lang.documentation.phpdoc.psi.impl.tags.PhpDocTagImpl` superclass changed from `com.jetbrains.php.lang.documentation.phpdoc.psi.impl.PhpDocPsiElementImpl` to `com.jetbrains.php.lang.psi.elements.impl.PhpNamedElementImpl` | It's necessary to check that the code doesn't rely on the superclass. The change also affects all the inheritors of `PhpDocTagImpl`. |
