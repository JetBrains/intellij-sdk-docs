...
| [`LookupManagerListener#TOPIC`](upsource:///platform/lang-impl/src/com/intellij/codeInsight/lookup/LookupManagerListener.java) | [`LookupManagerListener`](upsource:///platform/lang-impl/src/com/intellij/codeInsight/lookup/LookupManagerListener.java) |
...
| [`RunnablesListener#TOPIC`](upsource:///platform/platform-impl/src/com/intellij/diagnostic/RunnablesListener.java) ![Experimental API][experimental] | [`RunnablesListener`](upsource:///platform/platform-impl/src/com/intellij/diagnostic/RunnablesListener.java) |
...
| [`ExecutionTargetManager#TOPIC`](upsource:///platform/lang-api/src/com/intellij/execution/ExecutionTargetManager.java) | [`ExecutionTargetListener`](upsource:///platform/lang-api/src/com/intellij/execution/ExecutionTargetListener.java) |
...
| [`RunDashboardManager#DASHBOARD_TOPIC`](upsource:///platform/lang-api/src/com/intellij/execution/dashboard/RunDashboardManager.java) | [`RunDashboardListener`](upsource:///platform/lang-api/src/com/intellij/execution/dashboard/RunDashboardListener.java) |
...
| [`RunContentManager#TOPIC`](upsource:///platform/lang-api/src/com/intellij/execution/ui/RunContentManager.java) | [`RunContentWithExecutorListener`](upsource:///platform/lang-api/src/com/intellij/execution/ui/RunContentWithExecutorListener.java) |
| [`FacetManager#FACETS_TOPIC`](upsource:///platform/lang-api/src/com/intellij/facet/FacetManager.java) | [`FacetManagerListener`](upsource:///platform/lang-api/src/com/intellij/facet/FacetManagerListener.java) |
...
| [`FindManager#FIND_MODEL_TOPIC`](upsource:///platform/lang-api/src/com/intellij/find/FindManager.java) | [`FindModelListener`](upsource:///platform/lang-api/src/com/intellij/find/FindModelListener.java) |
...
| [`Notifications#TOPIC`](upsource:///platform/platform-api/src/com/intellij/notification/Notifications.java) | [`Notifications`](upsource:///platform/platform-api/src/com/intellij/notification/Notifications.java) |
...
| [`ApplicationActivationListener#TOPIC`](upsource:///platform/platform-api/src/com/intellij/openapi/application/ApplicationActivationListener.java) | [`ApplicationActivationListener`](upsource:///platform/platform-api/src/com/intellij/openapi/application/ApplicationActivationListener.java) |
...
| [`DocumentBulkUpdateListener#TOPIC`](upsource:///platform/core-impl/src/com/intellij/openapi/editor/ex/DocumentBulkUpdateListener.java) | [`DocumentBulkUpdateListener`](upsource:///platform/core-impl/src/com/intellij/openapi/editor/ex/DocumentBulkUpdateListener.java) |
| [`ProjectDataImportListener#TOPIC`](upsource:///platform/external-system-api/src/com/intellij/openapi/externalSystem/service/project/manage/ProjectDataImportListener.java) | [`ProjectDataImportListener`](upsource:///platform/external-system-api/src/com/intellij/openapi/externalSystem/service/project/manage/ProjectDataImportListener.java) |
...
| [`FileTypeManager#TOPIC`](upsource:///platform/platform-api/src/com/intellij/openapi/fileTypes/FileTypeManager.java) | [`FileTypeListener`](upsource:///platform/platform-api/src/com/intellij/openapi/fileTypes/FileTypeListener.java) |
...
| [`ProjectLevelVcsManager#VCS_CONFIGURATION_CHANGED`](upsource:///platform/vcs-api/src/com/intellij/openapi/vcs/ProjectLevelVcsManager.java) | [`VcsListener`](upsource:///platform/vcs-api/src/com/intellij/openapi/vcs/VcsListener.java) |
| [`ProjectLevelVcsManager#VCS_CONFIGURATION_CHANGED_IN_PLUGIN`](upsource:///platform/vcs-api/src/com/intellij/openapi/vcs/ProjectLevelVcsManager.java) | [`VcsListener`](upsource:///platform/vcs-api/src/com/intellij/openapi/vcs/VcsListener.java) |
...
| [`Info#TOPIC`](upsource:///platform/platform-api/src/com/intellij/openapi/wm/StatusBar.java) ![Project-Level][project-level] | [`StatusBarInfo`](upsource:///platform/platform-api/src/com/intellij/openapi/wm/StatusBarInfo.java) |
...
| [`CodeStyleSettingsMigrationListener#TOPIC`](upsource:///platform/code-style-api/src/com/intellij/psi/codeStyle/CodeStyleSettingsMigrationListener.java) ![Internal API][internal] | [`CodeStyleSettingsMigrationListener`](upsource:///platform/code-style-api/src/com/intellij/psi/codeStyle/CodeStyleSettingsMigrationListener.java) |
...
| [`RefactoringEventListener#REFACTORING_EVENT_TOPIC`](upsource:///platform/lang-api/src/com/intellij/refactoring/listeners/RefactoringEventListener.java) | [`RefactoringEventListener`](upsource:///platform/lang-api/src/com/intellij/refactoring/listeners/RefactoringEventListener.java) |
...
| [`ProjectTaskListener#TOPIC`](upsource:///platform/lang-api/src/com/intellij/task/ProjectTaskListener.java) | [`ProjectTaskListener`](upsource:///platform/lang-api/src/com/intellij/task/ProjectTaskListener.java) |
...
| [`VcsProjectLog#VCS_PROJECT_LOG_CHANGED`](upsource:///platform/vcs-log/impl/src/com/intellij/vcs/log/impl/VcsProjectLog.java) | [`ProjectLogListener`](upsource:///platform/vcs-log/impl/src/com/intellij/vcs/log/impl/VcsProjectLog.java) |
