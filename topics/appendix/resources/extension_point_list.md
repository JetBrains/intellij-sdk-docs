...
1303 Extension Points (EP) and 189 Listeners for
...
| [`ExecutionManager#EXECUTION_TOPIC`](upsource:///platform/lang-api/src/com/intellij/execution/ExecutionManager.kt) ![Project-Level][project-level] | [`ExecutionListener`](upsource:///platform/lang-api/src/com/intellij/execution/ExecutionListener.java) |
...
| [`StateWidgetManager#TOPIC`](upsource:///platform/execution-impl/src/com/intellij/execution/segmentedRunDebugWidget/StateWidgetManager.kt) ![Internal API][internal] | [`StateWidgetManagerListener`](upsource:///platform/execution-impl/src/com/intellij/execution/segmentedRunDebugWidget/StateWidgetManager.kt) |
...
| [`TrustChangeNotifier#TOPIC`](upsource:///platform/platform-impl/src/com/intellij/ide/impl/TrustedProjects.kt) ![Experimental API][experimental] | [`TrustChangeNotifier`](upsource:///platform/platform-impl/src/com/intellij/ide/impl/TrustedProjects.kt) |
...
| [`DynamicPluginListener#TOPIC`](upsource:///platform/core-impl/src/com/intellij/ide/plugins/DynamicPluginListener.kt) | [`DynamicPluginListener`](upsource:///platform/core-impl/src/com/intellij/ide/plugins/DynamicPluginListener.kt) |
...
| [`EditorColorsManagerListener#TOPIC`](upsource:///platform/platform-impl/src/com/intellij/openapi/editor/colors/impl/EditorColorsManagerListener.kt) | [`EditorColorsManagerListener`](upsource:///platform/platform-impl/src/com/intellij/openapi/editor/colors/impl/EditorColorsManagerListener.kt) |
...
| [`CommitModeManager#COMMIT_MODE_TOPIC`](upsource:///platform/vcs-impl/src/com/intellij/vcs/commit/CommitModeManager.kt) | [`CommitModeListener`](upsource:///platform/vcs-impl/src/com/intellij/vcs/commit/CommitModeManager.kt) |
...
| [`CompilerTopics#COMPILATION_STATUS`](upsource:///java/compiler/openapi/src/com/intellij/openapi/compiler/CompilerTopics.java) | [`CompilationStatusListener`](upsource:///java/compiler/openapi/src/com/intellij/openapi/compiler/CompilationStatusListener.java) |
...
| [`GitStashCache#GIT_STASH_LOADED`](upsource:///plugins/git4idea/src/git4idea/stash/GitStashCache.kt) | [`StashLoadedListener`](upsource:///plugins/git4idea/src/git4idea/stash/GitStashCache.kt) |
...
| [`FontChangedListener#TOPIC`](upsource:///plugins/markdown/src/org/intellij/plugins/markdown/settings/MarkdownApplicationSettings.java) | [`FontChangedListener`](upsource:///plugins/markdown/src/org/intellij/plugins/markdown/settings/MarkdownApplicationSettings.java) |
| [`SettingsChangedListener#TOPIC`](upsource:///plugins/markdown/src/org/intellij/plugins/markdown/settings/MarkdownApplicationSettings.java) | [`SettingsChangedListener`](upsource:///plugins/markdown/src/org/intellij/plugins/markdown/settings/MarkdownApplicationSettings.java) |
| [`MavenImportListener#TOPIC`](upsource:///plugins/maven/src/main/java/org/jetbrains/idea/maven/project/MavenImportListener.java) | [`MavenImportListener`](upsource:///plugins/maven/src/main/java/org/jetbrains/idea/maven/project/MavenImportListener.java) |
...
| [`GHAccountManager#ACCOUNT_REMOVED_TOPIC`](upsource:///plugins/github/src/org/jetbrains/plugins/github/authentication/accounts/GHAccountManager.kt) | [`AccountRemovedListener`](upsource:///plugins/github/src/org/jetbrains/plugins/github/authentication/accounts/GHAccountManager.kt) |
| [`GHAccountManager#ACCOUNT_TOKEN_CHANGED_TOPIC`](upsource:///plugins/github/src/org/jetbrains/plugins/github/authentication/accounts/GHAccountManager.kt) | [`AccountTokenChangedListener`](upsource:///plugins/github/src/org/jetbrains/plugins/github/authentication/accounts/GHAccountManager.kt) |
