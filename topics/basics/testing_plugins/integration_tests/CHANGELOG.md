...
<link-summary>Walkthrough notable changes, fixes, and breaking changes of the IntelliJ IDE Starter framework by release.</link-summary>

## 2026.2

* Examples were moved to a separate GitHub repository: [ide-starter-examples](https://github.com/JetBrains/ide-starter-examples)
* Source code was moved to the community code base.
  Most of the relevant modules can be found [here](%gh-ic%/tools).
...
* IC test cases were dropped as IC was merged with IU in 2025.3
