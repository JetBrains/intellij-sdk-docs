...
- [`JavaInlayParameterHintsProvider`](%gh-ic%/java/java-impl/src/com/intellij/codeInsight/hints/JavaInlayParameterHintsProvider.kt) - shows parameter hints in Java code
