...
<list>
    <li>The current step: “Uploading file 3 of 10”</li>
    <li>The current step: “Uploading file 3 of 10”</li>
    <li>Remaining time or percentage completed</li>
    <li>Round the remaining time to one of the following values: 1, 2, 3, 5, 10, 15, 20, or 30 seconds (or minutes). For example, if 7 minutes and 50 seconds remain, show “About 10 minutes left.” If less than 5 seconds remain, show “About 5 seconds left.”</li>
</list>
