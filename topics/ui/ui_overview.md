...
## Main toolbar
The main toolbar provides the most frequently used tools for working with projects:
...
### Run widget
Dropdown for choosing run configurations and buttons for running and debugging the code:
...
On Windows and Linux, the toolbar also includes the button for expanding the main menu:
...
See more details on working with tabs in the editor in [Editor tabs](https://www.jetbrains.com/help/idea/using-code-editor.html#manage_tabs) and on the UI component in [Tabs](tabs.md).
