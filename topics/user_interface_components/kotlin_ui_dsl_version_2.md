...
**UI DSL Showcase Tab**: Basics (Sources: [`DemoBasics`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoBasics.kt))
...
**UI DSL Showcase Tab**: Gaps (Sources: [`DemoGaps`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoGaps.kt))
...
**UI DSL Showcase Tab**: Groups (Sources: [`DemoGroups`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoGroups.kt))
...
**UI DSL Showcase Tab**: Row Layout (Sources: [`DemoRowLayout`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoRowLayout.kt))
...
**UI DSL Showcase Tab**: Comments (Sources: [`DemoComments`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoComments.kt))
...
**UI DSL Showcase Tab**: Enabled/Visible (Sources: [`DemoAvailability`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoAvailability.kt))
...
**UI DSL Showcase Tab**: Tips (Sources: [`DemoExamples`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoExamples.kt))

Marks a column of the cell as resizable: the column occupies all extra horizontal space in the panel and changes size together with the panel.
...
**UI DSL Showcase Tab**: Components Labels (Sources: [`DemoComponentLabels`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoComponentLabels.kt))
...
**UI DSL Showcase Tab**: Binding (Sources: [`DemoBinding`](%gh-ic%/plugins/devkit/intellij.devkit.uiDsl/src/showcase/DemoBinding.kt))
