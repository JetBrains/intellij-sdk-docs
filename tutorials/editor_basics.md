...
![String replacement action](editor/img/basics.png)
...
![Show coordinates action](editor/img/coordinates_action.png)

Perform the action to see caret positions:
![Show coordinates action](editor/img/coordinates_demo.png)
